...
- **Never use code-reading tools during initial decomposition** — The initial decomposition information source is workspace.yml requirement ONLY. No Read, Bash, Glob, Grep, or Explore tools. If code detail is needed to answer a question, it's an Open Question for Phase 2, not something to resolve during the initial decomposition.
